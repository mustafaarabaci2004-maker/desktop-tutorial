...
- `index.html` — Accueil
- `services.html` — Détail des services (film anti-chaleur/UV, confidentialité, sécurité, décoratif)
- `galerie.html` — Galerie de réalisations (visuels placeholders à remplacer par de vraies photos)
